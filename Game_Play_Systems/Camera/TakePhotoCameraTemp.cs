...
namespace CLIP.Project_Mouse.UI
{
    ...
    public class TakePhotoCameraTemp : MonoBehaviour
    {
        ...
        [Header("Scale")]
        public float minScaleSize = 8;
        public float maxScaleSize = 30;
        ...
        {
            if(InputManager.Instance.JoystickInput != Vector2.zero)
            {
                return;
            }
