...
namespace CLIP.Project_Mouse.Client_Event_Systems
{

    [CreateAssetMenu(fileName = "Warehouse_UI_Event_Hub_SO", menuName = "Project_Mouse/Client_Event_Systems/Warehouse_UI_Event_Hub_SO")]
    public class Warehouse_UI_Event_Hub_SO : ScriptableObject
    {
        public UnityEvent<string> _selected_item_change = new UnityEvent<string>();
        public UnityEvent _deselected_item = new UnityEvent();
        ...
        public UnityEvent _first_level_search_tag_change_in_dispatch = new UnityEvent();
        ...
        public void _invoke_deselected_item()
        {
            //Debug.Log("_invoke_deselected_item()");

            _deselected_item.Invoke();
        }
        ...
        public void _invoke_first_level_search_tag_change_change_in_dispatch()
        {
            //Debug.Log("_invoke_first_level_search_tag_change_in_dispatch()");

            _first_level_search_tag_change_in_dispatch.Invoke();
        }
