...
public class ThreeD_Camera_Control : MonoBehaviour
{
    public Button btn_0;
    public Button btn_1;
    public Button btn_2;
    ...
    void Start()
    {
        ...
        btn_0.onClick.AddListener(() =>{
            ...
            move_cam(_camera.transform.up* move_scale);
        ...
        btn_1.onClick.AddListener(() => {
            ...
            if (_camera == null) return;
            move_cam(_camera.transform.up * move_scale * -1.0f);
        ...
        btn_2.onClick.AddListener(() => {
            if (_camera == null) return;
            move_cam(_camera.transform.right * move_scale * -1.0f);



        });
        btn_3.onClick.AddListener(() => {
            move_cam(_camera.transform.right * move_scale);
