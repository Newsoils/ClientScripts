...
namespace CLIP.Project_Mouse.UI
{
    public class AchievementPanel : UIPanelBase
    {
        ...
        // 初始化成就详情界面
        private void InitAchievementDetail(AchievementUnit achievementUnit, bool isMystery = false)
        {
        ...
        // 初始化成就界面
        private void InitAchievementPanel()
        {
            // 已展示的成就
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                displayedAchievementUnits[i].InitAchievementUnit(displayedAchievementInfo[i], true);
            }
            ...
            for (int i = 0; i < 7; i++)
            {
                ...
                allAchievementsUnits[i].InitAchievementUnit(allAchievementInfo[i], false, true);
            }
        ...
        public void OpenAllAchievementsPanel()
        {
            ...
            for (int i = 0; i < needCount; i++)
            {
                ...
                item.InitAchievementUnit(achievementSO.achievement_db[i]);
            }
        ...
        public void ConfirmChangeAchievement()
        {
            ...
            achievementToChange.InitAchievementUnit(selectedIcon.info, true);
