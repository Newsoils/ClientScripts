...
namespace CLIP
{
    namespace Project_Mouse
    {
        namespace UI
        {
            ...
            public class LeanPinchCamera_Modified : MonoBehaviour
            {
                public float minPinchDelta = 0.1f;
                ...
                protected virtual void LateUpdate()
                {
                    ...
                    //Debug.Log("Pinch Ratio: " + pinchRatio);
                    ...
                    if (pinchRatio != 1.0f && (pinchRatio >= 1 + minPinchDelta || pinchRatio <= 1 - minPinchDelta))
                    {
