...
{
    [System.Serializable]
    public class NPCDialogueModel : BaseDialogueModel
    {
        ...
        [JsonConstructor]
        public NPCDialogueModel(int _dialogueId, EnumDialogueSpeaker _speaker, string _contents, int _nextDialogueId, bool _hasOptionDialogue = false, bool _isLastDialogue = false)
        {
