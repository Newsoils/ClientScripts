...
{
    [System.Serializable]
    public class CharacterDialogueModel : BaseDialogueModel
    {
        ...
        [JsonConstructor]
        public CharacterDialogueModel(int _dialogueId, EnumDialogueSpeaker _speaker, string _contents, int _nextDialogueId, bool _hasOptionDialogue = false, bool _isLastDialogue = false)
        {
